...
class BuscadorSugerenciasAdapter(private val Lista: List<User>, private val context: Context, private val userService: IUserService) :
    ...
    override fun onBindViewHolder(holder: TextoHolder, position: Int) {
        ...
        holder.botonAñadirAmigo.setOnClickListener(){
            userService.followUser(usuario.id, elem.id, object : UserRepository.callbackFollowUser {
                override fun onSuccess(mensaje: String) {// Dentro de tu actividad o fragmento
